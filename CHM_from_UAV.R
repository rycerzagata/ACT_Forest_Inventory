...
treetops_beech <- vwf(CHM = CHM_beech, winFun = lin_beech, minHeight = 15)
...
plot(crowns_beech, main="Detected Beech crowns", col=sample(rainbow(50), length(unique(crowns_beech[])),replace=TRUE), 
     legend=FALSE, xaxt="n", yaxt="n")
