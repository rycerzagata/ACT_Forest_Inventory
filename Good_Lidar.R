...
beechLas <- lasclipRectangle(beechLas, 176167 , 473712, 176254, 473783)
...
sample_index <- c(9:10, 16:17, 19, 21, 23, 26:45, 50:51, 53, 55, 68:69, 75, 79, 82, 84, 88, 91, 95)
